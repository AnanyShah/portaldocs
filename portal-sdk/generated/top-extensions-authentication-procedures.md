...
**This feature is currently only enabled in the dogfood and RC Portal**
...
2. Remove the `resourceAccess` section from your extension configuration in the Portal repo.
